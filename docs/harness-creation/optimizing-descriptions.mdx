...
Every `HARNESS.md`, `SKILL.md`, and harness-level reference file has a `description` field in its frontmatter. Write this field as if you're answering the question: *"When should an agent use this?"*
